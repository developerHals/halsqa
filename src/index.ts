...
async function renderITTicketsPage(tickets: ITTicket[], search: string, isSuperuser: boolean): Promise<string> {
  const listHtml = tickets.length === 0 
    ...
    : tickets.map(t => {
        ...
        return `
          <article class="list-card" ${borderClass} data-status="${t.status}">
  ...
  return `
            ...
            <div id="statusFilterDropdown" style="display:none;position:absolute;left:0;top:100%;margin-top:0.5rem;background:#ffffff;border:1px solid #cbd5e1;border-radius:8px;box-shadow:0 10px 15px -3px rgba(0,0,0,0.1),0 4px 6px -2px rgba(0,0,0,0.05);padding:1rem;width:200px;z-index:100;">
              ...
              <div style="display:flex;flex-direction:column;gap:0.5rem;margin-bottom:0.75rem;">
                <label style="display:flex;align-items:center;gap:0.5rem;color:#000000 !important;cursor:pointer;font-weight:normal !important;width:100%;">
                  <input type="checkbox" class="status-filter-checkbox" value="pending" style="cursor:pointer;width:1.1rem !important;height:1.1rem !important;min-width:auto !important;max-width:none !important;margin:0 !important;padding:0 !important;border:1px solid #cbd5e1 !important;background:#fff !important;display:inline-block !important;" checked>
                ...
                <label style="display:flex;align-items:center;gap:0.5rem;color:#000000 !important;cursor:pointer;font-weight:normal !important;width:100%;">
                  <input type="checkbox" class="status-filter-checkbox" value="in_progress" style="cursor:pointer;width:1.1rem !important;height:1.1rem !important;min-width:auto !important;max-width:none !important;margin:0 !important;padding:0 !important;border:1px solid #cbd5e1 !important;background:#fff !important;display:inline-block !important;" checked>
                ...
                <label style="display:flex;align-items:center;gap:0.5rem;color:#000000 !important;cursor:pointer;font-weight:normal !important;width:100%;">
                  <input type="checkbox" class="status-filter-checkbox" value="closed" style="cursor:pointer;width:1.1rem !important;height:1.1rem !important;min-width:auto !important;max-width:none !important;margin:0 !important;padding:0 !important;border:1px solid #cbd5e1 !important;background:#fff !important;display:inline-block !important;" checked>
              ...
              <div style="display:flex;gap:0.5rem;justify-content:space-between;border-top:1px solid #e2e8f0;padding-top:0.5rem;">
                <button type="button" id="applyStatusFilterBtn" style="padding:0.25rem 0.5rem;background:#e11d48;color:white;border:none;border-radius:4px;font-size:0.75rem;font-weight:600;cursor:pointer;">Apply</button>
                <button type="button" id="clearStatusFilterBtn" style="padding:0.25rem 0.5rem;background:#f1f5f9;color:#334155;border:1px solid #cbd5e1;border-radius:4px;font-size:0.75rem;font-weight:600;cursor:pointer;">Clear</button>
              </div>
            </div>
          </div>
    ...
    <script>
      (function() {
        ...
        const downloadBtn = document.getElementById('downloadTicketsCsvBtn');
        if (downloadBtn) {
